      ...
      <div className="container">
        <div className="nav-scroller py-1 mb-3 border-bottom">
          <nav className="nav nav-underline justify-content-between">
            ...
            <a className="nav-item nav-link link-body-emphasis" href="#">ART</a>
            ...
            <a className="nav-item nav-link link-body-emphasis" href="#">CINEMA</a>
            <a className="nav-item nav-link link-body-emphasis" href="#">DESIGN</a>
            <a className="nav-item nav-link link-body-emphasis" href="#">FOOD</a>
            <Link to={`/blog/write`}>
