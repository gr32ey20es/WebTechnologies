    ...
    <>
      <div className="container">
        <div className="nav-scroller py-1 mb-3 border-bottom">
          <nav className="nav nav-underline" style={{display: 'flex', justifyContent:'center'}}>
        ...
        <div className="row g-5">
          <div className="col-md-9">
            ...
            ></img>
            <div className="card-body" style={{ display: "flex", height: 100}}>
              <img
                ...
                style={{ width: 70, height: 70, display: "inline-block", margin: "5px" }}
              />
